...
| [BulkXfer_Uuid.h](BulkXfer_Uuid.h) | Default service / characteristic UUIDs | Yes (`uuid.h`, project `BaseUUIDs.h`) |
...
[examples/BaseUUIDs.h](examples/BaseUUIDs.h) (base `DBB1-4D99-AB6E-F441EC7C092B`).
